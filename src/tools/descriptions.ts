export const descriptions = {
  ...
  repo_prepare_codex_task:
    "Use this when the user asks for a Codex prompt returned in chat for review.",
  repo_write_codex_task:
    "Use this when the user asks to write a Codex prompt into the repo for later execution.",
  repo_codex_review:
